...
// Grade options
export const GRADES = ['A+', 'A', 'A-', 'B+', 'B', 'B-', 'C+', 'C', 'C-', 'D+', 'D', 'F'];
...
export const NAV_ITEMS = {
  ADMIN: [
    ...
    { name: 'Enrollments', path: '/enrollments', icon: 'ClipboardDocumentListIcon' },
  ...
  STUDENT: [
    { name: 'Dashboard', path: '/dashboard', icon: 'HomeIcon' },
    { name: 'Courses', path: '/courses', icon: 'BookOpenIcon' },
    { name: 'My Enrollments', path: '/enrollments', icon: 'ClipboardDocumentListIcon' },
